...
/**
 * 初始化主题， 优先级 query > cookies > config.js
 * @param {*} theme
 * @param {*} changeTheme
 */
export const initTheme = (theme, changeTheme) => {
  if (isBrowser()) {
    // const queryTheme = getQueryVariable('theme') || loadThemeFromCookies() || CONFIG.THEME
    const queryTheme = getQueryVariable('theme') || CONFIG.THEME
